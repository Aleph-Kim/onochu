...
<link rel="stylesheet" type="text/css" href="<?= $_SERVER['CSS_PATH'] . 'login.css' ?>">
...
<div class="container">
    <div class="login-box">
        ...
        <div class="login-text">
            <p>간편하게 로그인하고</p>
            <p>노래 추천 서비스를 이용해보세요.</p>
            <p>복잡한 회원가입은 필요없어요.</p>
            <p>버튼만 한 번 눌러주세요.</p>
        </div>
        <a href="/auth/login" class="kakao-login-btn">
        ...
        <a href="/" class="email-login-link">다음에 로그인 하기</a>
    </div>
</div>
